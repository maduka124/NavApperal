...
table 50597 CutCreationLine
{
    DataClassification = ToBeClassified;

    fields
    {
        field(1; "CutCreNo."; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = SewingJobCreationLine4."SubLotNo." where("Style No." = field("Style No."), "Lot No." = field("Lot No."));
            ValidateTableRelation = false;
        }
        ...
        field(84; "Component Group Code"; Code[50])
        {
            DataClassification = ToBeClassified;
        }
    ...
    keys
    {
        key(PK; "CutCreNo.", "Marker Name", "Line No")
        {
            Clustered = true;
        }
    }
