...
table 50593 SewingJobCreationLine4
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = SewingJobCreationLine3."SubLotNo." where("SJCNo." = field("SJCNo."), "Style No." = field("Style No."),
            "Lot No." = field("Lot No."), "Record Type" = filter(<> 'H1'));
        ...
        field(82; "LineNo"; BigInteger)
        {
            DataClassification = ToBeClassified;
        }

        field(83; "Resource No."; Code[20])
        {
            DataClassification = ToBeClassified;
        }

        field(84; "Resource Name"; Text[50])
        {
            DataClassification = ToBeClassified;
        ...
        field(85; "Plan Date"; Date)
        {
            DataClassification = ToBeClassified;
        }

        field(86; "Plan Target"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
    ...
    keys
    {
        key(PK; "SJCNo.", "Style No.", "lot No.", "SubLotNo.", LineNo)
        {
            Clustered = true;
        }
    }
