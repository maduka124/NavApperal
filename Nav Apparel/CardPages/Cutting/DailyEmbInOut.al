page 50360 "Daily Embroidary In/Out Card"
{
            ...
            group(General)
            {
                ...
                field("Input Qty"; rec."Input Qty")
                {
                    ...
                    begin
                        ...
                        if rec."Input Qty" > StyleMasterPORec."Cut In Qty" then  //"Cut In Qty" equal to the bundle guide Qty
    ...
    begin
        ...
        if (rec."Style No." <> '') and (rec."Lot No." <> '') then begin
            ...
            if rec."Input Qty" > StyleMasterPORec."Cut In Qty" then begin  //"Cut In Qty" equal to the bundle guide Qty
                Error('Input quantity is greater than Bundle Guide quantity.');
                exit;
            end;

            //Check Input qty with output qty
            if StyleMasterPORec."Emb In Qty" < rec."Output Qty" then begin
