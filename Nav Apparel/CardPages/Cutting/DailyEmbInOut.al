page 50360 "Daily Embroidary In/Out Card"
{
    PageType = Card;
            ...
            group(General)
            {
                ...
                field("Input Qty"; "Input Qty")
                {
                    ...
                    begin
                        ...
                        if "Input Qty" > StyleMasterPORec."Cut In Qty" then  //"Cut In Qty" equal to the bundle guide Qty
                            Error('Input quantity is greater than the Bundle Guide total quantity.');
    ...
    begin
        ...
        if ("Style No." <> '') and ("Lot No." <> '') then begin
            ...
            if "Input Qty" > StyleMasterPORec."Cut In Qty" then begin  //"Cut In Qty" equal to the bundle guide Qty
                Error('Input quantity is greater than Bundle Guide quantity.');
                exit;
            end;

            //Check Input qty with output qty
            if StyleMasterPORec."Emb In Qty" < "Output Qty" then begin
                Error('Embroidary output quantity is greater than Embroidary input total quantity.');
                exit;
            end;
    ...
    begin
        NavAppCodeUnit.Delete_Prod_Records("No.", "Style No.", "Lot No.", 'IN', 'Emb', Type::Emb);
        NavAppCodeUnit.Delete_Prod_Records("No.", "Style No.", "Lot No.", 'OUT', 'Emb', Type::Emb);
    end;
}