page 50983 "Assortment Card"
{
            ...
            action("Adjust Sales Orders")
            {
                ...
                begin
                    ...
                    repeat
                        ...
                        BOMPOSelectionRec.SetRange("Lot No.", StyleMasterPORec."lot No.");
                        ...
                        /////////////////////////////////////////////Add Sencitivity
                        ColorSensitivity(BOMRec.No, StyleMasterPORec."lot No.");
                        SizeSensitivity(BOMRec.No, StyleMasterPORec."lot No.");
                        CountrySensitivity(BOMRec.No, StyleMasterPORec."lot No.");
                        ItemPOSensitivity(BOMRec.No, StyleMasterPORec."lot No.");
                        ...
                        if Mode <> 'NEW' then begin
                            ...
                            BLAutoGenNewRec.SetRange("Lot No.", StyleMasterPORec."lot No.");
                                        ...
                                        repeat
                                            ...
                                            if BOMLine2Rec.FindSet() then begin
                                                repeat
                                                    ...
                                                    BOMPOSelecRec.SetRange("Lot No.", StyleMasterPORec."lot No.");
                    ...
                    repeat
                        ...
                        AssortDetailRec.SetRange("lot No.", StyleMasterPORec."lot No.");
    ...
    procedure ColorSensitivity(BOMNo: Code[20]; lotNo: code[20])
    var
        BOMLIneEstimateRec: Record "BOM Line Estimate";
    ...
    begin
        ...
        if BOMLIneEstimateRec.FindSet() then begin
            repeat
                ...
                BOMLInePORec.SetRange("Lot No.", lotNo);
    ...
    procedure SizeSensitivity(BOMNo: Code[20]; lotNo: code[20])
    var
        BOMLIneEstimateRec: Record "BOM Line Estimate";
    ...
    procedure CountrySensitivity(BOMNo: Code[20]; lotNo: code[20])
    var
        BOMLIneEstimateRec: Record "BOM Line Estimate";
    ...
    procedure ItemPOSensitivity(BOMNo: Code[20]; lotNo: code[20])
    var
        BOMLIneEstimateRec: Record "BOM Line Estimate";
    ...
    begin
        ...
        BOMLineItemPORec.SetRange("Lot No.", lotNo);
