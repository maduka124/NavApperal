        ...
        area(content)
        {
            ...
            usercontrol(conVSControlAddIn; NetronicVSControlAddIn)
            {
                ...
                begin
                    ...
                    _settings.Add('LicenseKey', 'ODk5ODE4LTM0NzA0MS01ODc4NTcteyJ3IjoiIiwiaWQiOiJWU0NBSUV2YWwiLCJuIjoiTkVUUk9OSUMiLCJ1IjoiIiwiZSI6MjMwNiwidiI6IjQuMCIsImYiOlsxMDAxXSwiZWQiOiJCYXNlIn0=');
                ...
                begin
                    ...
                    if _contextMenuID = 'CM_Entity' then begin
                        ...
                        if _contextMenuItemCode = 'E_07' then begin   //Delete From Queue  
                            if FactoryNo = '' then
                                Error('Select a factory');
                    ...
                    if _contextMenuID = 'CM_Allocation' then begin
                        ...
                        if _contextMenuItemCode = 'Al_12' then begin   //Search By Style/Return To Queue
                            if FactoryNo = '' then
                                Error('Select a factory');
