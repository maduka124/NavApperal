        ...
        area(content)
        {
            ...
            usercontrol(conVSControlAddIn; NetronicVSControlAddIn)
            {
                ...
                begin
                    ...
                    _settings.Add('LicenseKey', 'NDY1MTQ5LTIxNDI0Ny0yOTkyODAteyJ3IjoiIiwiaWQiOiJWU0NBSUV2YWwiLCJuIjoiTkVUUk9OSUMiLCJ1IjoiIiwiZSI6MjMwMSwidiI6IjQuMCIsImYiOlsxMDAxXSwiZWQiOiJCYXNlIn0=');
                        ...
                        if _objID <> '' then begin
                            ...
                            if JobPlaLineRec.FindSet() then begin
                                ...
                                repeat
                                    ...
                                    TargetPerDay := round(((60 / JobPlaLineRec.SMV) * JobPlaLineRec.Carder * HoursPerDay * JobPlaLineRec.Eff) / 100, 1, '>');
                                    TargetPerHour := TargetPerDay / HoursPerDay;
                                    // TargetPerHour := round(TargetPerDay / HoursPerDay, 1, '>');
