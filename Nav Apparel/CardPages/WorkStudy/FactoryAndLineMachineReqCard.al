                                ...
                                if StyleWiseMachineLineRec.FindSet() then begin
                                    repeat
                                        ...
                                        if not FactoryAndLine2Rec.FindSet() then begin
                                            ...
                                            if D = 1 then
                                                FactoryAndLine2Rec."1" := FactoryAndLine2Rec."1" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 2 then
                                                FactoryAndLine2Rec."2" := FactoryAndLine2Rec."2" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 3 then
                                                FactoryAndLine2Rec."3" := FactoryAndLine2Rec."3" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 4 then
                                                FactoryAndLine2Rec."4" := FactoryAndLine2Rec."4" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 5 then
                                                FactoryAndLine2Rec."5" := FactoryAndLine2Rec."5" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 6 then
                                                FactoryAndLine2Rec."6" := FactoryAndLine2Rec."6" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 7 then
                                                FactoryAndLine2Rec."7" := FactoryAndLine2Rec."7" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 8 then
                                                FactoryAndLine2Rec."8" := FactoryAndLine2Rec."8" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 9 then
                                                FactoryAndLine2Rec."9" := FactoryAndLine2Rec."9" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 10 then
                                                FactoryAndLine2Rec."10" := FactoryAndLine2Rec."10" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 11 then
                                                FactoryAndLine2Rec."11" := FactoryAndLine2Rec."11" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 12 then
                                                FactoryAndLine2Rec."12" := FactoryAndLine2Rec."12" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 13 then
                                                FactoryAndLine2Rec."13" := FactoryAndLine2Rec."13" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 14 then
                                                FactoryAndLine2Rec."14" := FactoryAndLine2Rec."14" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 15 then
                                                FactoryAndLine2Rec."15" := FactoryAndLine2Rec."15" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 16 then
                                                FactoryAndLine2Rec."16" := FactoryAndLine2Rec."16" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 17 then
                                                FactoryAndLine2Rec."17" := FactoryAndLine2Rec."17" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 18 then
                                                FactoryAndLine2Rec."18" := FactoryAndLine2Rec."18" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 19 then
                                                FactoryAndLine2Rec."19" := FactoryAndLine2Rec."19" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 20 then
                                                FactoryAndLine2Rec."20" := FactoryAndLine2Rec."20" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 21 then
                                                FactoryAndLine2Rec."21" := FactoryAndLine2Rec."21" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 22 then
                                                FactoryAndLine2Rec."22" := FactoryAndLine2Rec."22" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 23 then
                                                FactoryAndLine2Rec."23" := FactoryAndLine2Rec."23" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 24 then
                                                FactoryAndLine2Rec."24" := FactoryAndLine2Rec."24" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 25 then
                                                FactoryAndLine2Rec."25" := FactoryAndLine2Rec."25" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 26 then
                                                FactoryAndLine2Rec."26" := FactoryAndLine2Rec."26" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 27 then
                                                FactoryAndLine2Rec."27" := FactoryAndLine2Rec."27" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 28 then
                                                FactoryAndLine2Rec."28" := FactoryAndLine2Rec."28" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 29 then
                                                FactoryAndLine2Rec."29" := FactoryAndLine2Rec."29" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 30 then
                                                FactoryAndLine2Rec."30" := FactoryAndLine2Rec."30" + StyleWiseMachineLineRec."Machine Qty New";
                                            if D = 31 then
                                                FactoryAndLine2Rec."31" := FactoryAndLine2Rec."31" + StyleWiseMachineLineRec."Machine Qty New";
