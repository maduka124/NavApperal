report 51406 HourlyProductionMerchandizing
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Merchandising Hourly Production Report';
    // RDLCLayout = 'Report_Layouts/Planning/HourlyProductionReport.rdl';
    RDLCLayout = 'Report_Layouts/Planning/HourlyProductionReportMerchandizing.rdl';
    DefaultLayout = RDLC;
        ...
        layout
        {
            area(Content)
            {
                group(GroupName)
                {
                    ...
                    field(MerchantFilter; MerchantFilter)
                    {
                        ApplicationArea = All;
