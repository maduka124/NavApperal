report 51397 WashingSendReceiveReport
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Washing Send & Receive Report';
    RDLCLayout = 'Report_Layouts/Washing/WashingSendReceiveReport.rdl';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("No.") where(Type = filter('Wash'));
