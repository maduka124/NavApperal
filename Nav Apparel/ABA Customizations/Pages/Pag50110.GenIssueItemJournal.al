page 50110 "Gen. Issue Item Journal"
{
    AdditionalSearchTerms = 'increase inventory,decrease inventory,adjust inventory,Item Journal';
    ApplicationArea = Basic, Suite;
    AutoSplitKey = true;
    Caption = 'General Issue Item Journals';
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("ABA Item No."; Rec."ABA Item No.")
                {
                    ApplicationArea = All;
                    Caption = 'Item No.';
...
//         }
    ...
    begin
        //RJ
        UserSetup.Get(UserId);
        if UserSetup."Requsting Department Name" <> '' then
            Rec.SetRange("Requsting Department Name", UserSetup."Requsting Department Name");
        //
    ...
    begin
        ...
        if Rec.IsOpenedFromBatch() then begin
            CurrentJnlBatchName := 'SPARE-PART';//Rec."Journal Batch Name";
            ItemJnlMgt.OpenJnl(CurrentJnlBatchName, Rec);
            SetControlAppearanceFromBatch();
            exit;
        end;
        ItemJnlMgt.TemplateSelection(PAGE::"Gen. Issue Item Journal", 0, false, Rec, JnlSelected);
